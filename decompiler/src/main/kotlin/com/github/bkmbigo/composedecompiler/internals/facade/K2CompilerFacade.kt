package com.github.bkmbigo.composedecompiler.internals.facade
...
internal class FirAnalysisResult(
...
internal class K2CompilerFacade(environment: KotlinCoreEnvironment) : KotlinCompilerFacade(environment) {
    ...
    override fun compile(
        ...
        codegenFactory.generateModuleInFrontendIRMode(
            ...
            backendExtension = FirJvmBackendExtension(components, frontendResult.firResult.irActualizedResult),
